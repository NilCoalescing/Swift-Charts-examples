// This is example code for the article "Using Measurements from Foundation for values in Swift Charts",
// that can be found at https://nilcoalescing.com/blog/UsingMeasurementsFromFoundationAsValuesInSwiftCharts/
